...
class image_converter:
  ...
  def __init__(self):
    self.angle_pub = rospy.Publisher("red_marker_vision", Point, queue_size=1)
    self.image_pub = rospy.Publisher("red_marker_debug",Image)
  ...
  def callback(self,data):
    ...
    red_marker_point = find_red_marker(img)
    cv_image2 = cv2.line(cv_image2,(0,0),(red_marker_point[0],red_marker_point[1]),(255,0,0),5)
    print 'red_marker_point', red_marker_point
    ...
    if red_marker_point != None:
        red_marker_point[0]=red_marker_point[0]-320
        red_marker_point[1]=red_marker_point[1]-240        
        self.angle_pub.publish(Point(*red_marker_point))
